...
Route::group(['prefix'=>'UserPanel','middleware'=>'checkCustomerLogin'],function () {
    ...
    Route::get('/Reservations',App\Http\Livewire\Customers\Pages\Reservations::class);
    Route::get('/Form',App\Http\Livewire\Customers\Pages\Form::class);
});
...
//reservations
Breadcrumbs::for('CustomerReservationsList', function ($trail) {
    $trail->push('Reservations / List', url('UserPanel/Reservations'));
});
